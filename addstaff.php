...
if (isset($_POST['save'])) {
    ...
    $query = mysqli_query($con, "INSERT INTO `tbl_addstaff`(`name`, `dob`, `phone`, `alph`, `joindate`, `address`, `educ`, `img`) VALUES ('$a','$b','$d','$e','$i','$f','$h','$g')");
    if ($query) {
        $qu = mysqli_query($con, "SELECT * FROM `tbl_addstaff` ORDER BY id DESC LIMIT 1 ");
        while ($d1 = mysqli_fetch_array($qu)) {
            $uid = $d1['id'];
        }
        $demo = mysqli_query($con, "INSERT INTO `tbl_register`(`uid`, `email`, `password`, `status`, `role`) VALUES ('$uid','$c','$b','0','staff')");
        if ($demo) {
            ...
            <div class="home-sub ">
                <div class="form bg-light col-9 mt-5" id="form" style="margin-left:150px;">
                    ...
                    <div class="form-sub ">
                        ...
                        <div class="form-floating  m-3 w-25">
                            <input type="text" class="form-control" placeholder="Qualification" name="educ" id="floatingInput">
