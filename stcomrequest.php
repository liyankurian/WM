...
<body>
    <div class="sidebar close">
        ...
        <ul class="nav-links">
            ...
            <li>
                <a href="stcomrequest.php">
                <i class='bx bxs-factory' style='color:#ffffff'  ></i>
                    <span class="link_name">Recycle Company Request</span>
                </a>
                <ul class="sub-menu blank">
                    <li><a class="link_name" href="stcomrequest.php">Recycle Company Request</a></li>
                </ul>
            </li>
