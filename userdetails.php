                    ...
                    <table class="table table-bordered">
                        <thead>
                            ...
                            <tr>
                                ...
                                <td><button class="btn btn-primary acbtn">Accept</button></td>
                                <td><button class="btn btn-danger rejbtn">Reject</button></td>  
                            </tr>
                        </thead>
                    <?php
                        }
...
<div class="modal fade" id="acmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="accept.php" method="POST">
                    ...
                    <button type="button" id="clso"  class="btn btn-secondary clso" data-dismiss="modal"> NO </button>
            ...
            <div class="modal-content">
                ...
                <form action="reject.php" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="text" name="res" placeholder="Write the reason for  rejection" required>
                    </div>
                    <div class="modal-footer">
                    <button type="button" class="btn btn-secondary"  id="close" data-dismiss="modal"> NO </button>
                        <input type="submit" name="reason" class="btn btn-danger" value=" Yes !! reject it">
                    </div>
                </form>
