                ...
                while ($pickrow = mysqli_fetch_array($pick)) {
                 ...
                 <table class="table table-bordered">
                        <thead>
                            ...
                            <tr>
                                <?php
                                $dr = mysqli_query($con,"SELECT `name` FROM `tbl_driverdetails`");
                                ...
                                <select name="driver"  style="height:6vh;" id="driver">
                                    ...
                                    <option value="<?php echo $dri['name'];?>"><?php echo $dri['name'];?></option>
                                </select>
                                <?php
                                }
                                ?>
                                
                                <input type="submit" value="Assign" class="btn btn-primary" name="asgn">
                                </form>
                                <?php
                                if(isset($_POST['asgn']))
                                {
